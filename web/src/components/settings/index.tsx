...
import {
    Add,
    AdminPanelSettings,
    Close, Delete, Settings as SettingsIcon
            ...
            <Modal open={open} onClose={
                ...
                <>
                    ...
                    <Grid container>
                        ...
                        {settings && <Grid container spacing={2}>
                            <>
                                ...
                                <Grid item xs={4}>
                                    <Card key="isSteamCMDRunning">
                                        <CardHeader
                                            ...
                                            action={
                                                <Checkbox checked={settings.isSteamCMDRunning} disabled />
                                            }
                                        />
                                    </Card>
                                </Grid>
                                <Grid item xs={4}>
                                    <Card key="debug">
                                        <CardHeader
                                            title="Debug"
                                            action={
                                                <Checkbox checked={settings.debug} onClick={
                                                    () => {
                                                        setSettings({
                                                            ...settings,
                                                        ...
                                                        action={
                                                            <>
                                                                ...
                                                                {user.email !== userList.email ?
                                                                    <EditUser editUser={userList} setUsers={setUsers} />
                                                                    : null}
                                                                {user.email !== userList.email ?
                                                                    <IconButton aria-label="deleteUser" onClick={
                                                                        () => {
                                                                            deleteUser(userList.email, user.token)
                                                                                .then
                                                                                ((message) => {
                                                                                    getUsers(user.token)
                                                                                        .then((users) => {
                    ...
                    <AddUserModal open={openAddUser} setOpen={setOpenAddUser} setUsers={setUsers} />
                </>
            </Modal >
            :
            <IconButton
